...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="<?php base_url(); ?>/css/defaults.css" />
        ...
        <style>
            ...
            body { 
                background: url('<?php echo base_url(); ?>/images/bg_suburb.jpg') no-repeat center center fixed; 
