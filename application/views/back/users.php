    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="search-form" style="display:none">
                ...
                <form id="yw0" action="<?php echo base_url(); ?>User/users" method="get"><div class="form-horizontal" style="margin-top: 10px;">
            ...
            <div id="user-grid" class="grid-view">
                <table class="table table-striped table-custom">
                    <thead>
                        <tr>
                            <th id="user-grid_c0">
                                <a class="sort-link" href="<?php echo base_url(); ?>/back/user/index?User_sort=username">Username</a>
                            </th>
                            <th id="user-grid_c1">
                                <a class="sort-link" href="<?php echo base_url(); ?>/back/user/index?User_sort=firstname">ชื่อจริง</a>
                            </th>
                            <th id="user-grid_c2">
                                <a class="sort-link" href="<?php echo base_url(); ?>/back/user/index?User_sort=lastname">นามสกุล</a>
                            </th><th id="user-grid_c3">
                                <a class="sort-link" href="<?php echo base_url(); ?>/back/user/index?User_sort=province">จังหวัด</a>
                            </th><th id="user-grid_c4">
                                <a class="sort-link" href="<?php echo base_url(); ?>/back/user/index?User_sort=user_type">ประเภท</a>
                            </th>
                            <th id="user-grid_c5">
                                <a class="sort-link" href="<?php echo base_url(); ?>/back/user/index?User_sort=created">สร้าง</a>
                            </th>
                    ...
                    <tbody>
                        ...
                        while ($rs_user = $db->get($query_user)) {
                            ...
                            <tr class="<?php echo $tr; ?>">
                                <td>
                                    <a class="load_data" href="<?php echo base_url(); ?>/back/user/<?php echo $rs_user['id']; ?>"><?php echo $rs_user['username']; ?></a>
                                </td>
